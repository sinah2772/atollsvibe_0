...
const EditArticle: React.FC = () => {
  ...
  const [error, setError] = useState<string | null>(null);  const [showImageBrowser, setShowImageBrowser] = useState(false);
  ...
  // Scroll detection for collaborative presence positioning
  useEffect(() => {
    const handleScroll = () => {
  ...
  if (!user) {
    ...
    <div className="max-w-5xl mx-auto">
      ...
      {/* Side Collaborative Presence - visible when scrolled */}
      <div 
        className={`fixed left-4 md:left-6 top-1/2 transform -translate-y-1/2 z-40 transition-all duration-300 hover:scale-105 ${
      ...
      </div><div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">        {/* Auto Save Status */}
        <div className="mb-4">
          <AutoSaveStatus 
